 ...
 * emulator.
 * <P>
 * This class provides basic, common memory functionality for the
 * memory subsystem of the emulator. Specific methods are overriden
 ...
 *
 * @see org.razvan.jzx.v48.Memory
 * @see org.razvan.jzx.v128.Memory
 */
public abstract class BaseMemory extends BaseComponent {
	 ...
	 * <P>
	 * The sixteen possible phisical pages (4 ROM pages
	 * and 12 RAM pages.)
	 */
	 ...
	 * <P>
	 * This is used to update the screen whenever
	 * the appropriate memory area is modified.
	 */
	protected BaseScreen m_screen;
	
	/**
	 * Allocate the memory arrays, cache the screen
	 * component and pages in the appropriate memory
	 * pages.
	 * <P>
	 * Note that the cached screen reference can be null
	 * after this call, in the event that the BaseSpectrum
	 * parameter is itself null. This is allowed for
	 * "headless" memory objects that are not tied to
	 * a particular BaseSpectrum instance. This is used for
	 * loading the snapshot data into a memory instance, that
	 * is then copied directly into the physical BaseSpectrum
	 * memory instance.
	 *
	 * @see #pageIn
	 */
	...
	/**
	 * Sets the memory arrays to null and releases the
	 * cached screen reference.
	 */
	 ...
	 * <p>
	 * The ROM file is specified as a Java Resource and loaded by means
	 * of <tt>Class.getResource(String)</tt>.
	 *
	 * @param name The name of the resource where the ROM file resides.
	 * @param page The memory page into which to load the ROM file.
	 * @throws IOException Thrown if the resource is not found or an
	...
	/**
	 * Maps a particular physical page into a given
	 ...
	 * </UL>
	 *
	 * @param frame The virtual frame number. You cannot
	 * map a RAM page into frame 0.
	 * @param page The physical page number.
	 */
	public void pageIn(int frame, int page) {
		if ((frame == 0) && (page >= RAM0)) {
			m_logger.log(ILogger.C_DEBUG, "Ignored attempt to page RAM at 0x0000");
			return;
		}
	...
	/**
	 * Returns the byte array that comprises a particular
	 * page.
	 */
	 ...
	 * <P>
	 * The address is mapped into a frame number by
	 * taking the first two bits, and then frame number
	 * is then mapped into a physical page. The
	 * remaining address bits are used to index into
	 * the physical page.
	 *
	 * @param addr16 The 16-bit address to read from.
	 ...
	 * <P>
	 * If the address falls into the memory mapped
	 * area of the screen memory, the screen object
	 * is updated appropriately.
	 *
	 * @param addr16 The 16-bit address to write to.
	 * @param val8 The 8 bits to write at the specified address.
	 */
	 ...
	 * <P>
	 * The method calls <TT>read8()</TT> for two
	 * consecutive addresses and collates the results.
	 *
	 * @param addr16 The 16-bit address to start reading from.
	 * @return Returns the 16 bits from the two consecutive
	 * addresses.
	 *
	 * @see #read8
	 */
	 ...
	 * <P>
	 * The method calls <TT>write8()</TT> for two
	 * consecutive addresses, with the two halves of the
	 * specified argument.
	 *
	 * @param addr16 The 16-bit address to start writing to.
	 * @param val16 The 16 bits to start writing at the specified
	 * address.
	 *
	 * @see #write16
	 */
	...
	/**
	 * Load the memory contents from the given BaseLoader
	 * object.
	 * <P>
	 * The BaseLoader contains a "headless" memory object
	 * inside it, whose page contents are copied into
	 * the page contents of "this" memory object.
	 *
	 * @see BaseLoader
	 */
	...
	/**
	 * Return a string representation of the memory state, which
