 ...
 * <P>
 * This class provides basic, common spectrum functionality for the
 * various spectrum models.
 *
...
public abstract class BaseSpectrum extends BaseComponent {
	 ...
	 * 
	 * NOTE: This is set to 19 (instead of 20) because
	 * many games are frame-synchronized, and if they
	 * miss a screen refresh even by a little they wait 
	 * until the next one. This means that roughly one 
	 * out of two times, they will wait a frame too long. 
	 * This effectively reduces the framerate by 50% to
	 * around 30FPS. By setting the frequency to 19,
	 * we guarantee that an interrupt will have arrived
	 * by the next frame, so the effective framerate
	 * is around 50FPS.
	 */
	...
	/**
	 * Component that decorates the screen object for
	 * display in a Frame, Applet, etc.
	 */
	 ...
	 * <P>
	 * This value is retrieved by the screen object
	 * during its <TT>init()</TT> phase.
	 */
	 ...
	 * <P>
	 * This value is different for the different
	 * Spectrum models.
	 */
	...
	/**
	 * Allocate the clock object, and initialize all
	 * contained references (CPU, memory, I/O, screen
	 * and keyboard.)
	 */
	...
	/**
	 * Reset all contained references (CPU, memory, I/O,
	 * screen and keyboard.)
	 */
	public void reset() {
		m_cpu.reset();
	...
	/**
	 * Terminate all contained references (CPU, memory,
	 * I/O, screen and keyboard) and subsequently set
	 * them to null.
	 */
	...
	/**
	 * Trivial accessor for the issue (model) of
	 * this Spectrum.
	 */
	public int getIssue() {
		return m_issue;
	...
	/**
	 * Trivial accessor for the scale parameter of
	 * this Spectrum.
	 * <P>
	 * This method is called by the screen object
	...
	/**
	 * Trivial mutator for the scale parameter of
	 * this Spectrum.
	 */
	...
	/**
	 * Trivial accessor for the current TV line
	 * being drawn.
	 */
	public int getVline() {
		return m_vline;
	...
	/**
	 * Return a Container that decorates the Spectrum
	 * screen and adds other UI elements such as a
	 * status bar.
	 */
	 ...
	 *  <UL>
	 *  <LI>If the current CPU T-States is more
	 *  than the number of cycles per line,
	 *  increment the number of lines.</LI>
	 *  <LI>If the number of lines is greater than
	 *  the number of lines per frame:</LI>
	 *      <UL>
	 *      <LI>If this is the 25th frame (twice per
	 *      second) toggle the flash.</LI>
	 *      </UL>
	...
	/**
	 * Load the Spectrum contents from the given
	 * loader, by calling the <TT>load()</TT>
	 * method of all contained components.
	 */
