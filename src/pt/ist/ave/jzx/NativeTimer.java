 ...
 * 
 * <P>
 * Makes use of a JNI library, if possible; if the library does not exist or is
 * not accessible in the current security context (e.g. Applet), default to
 * returning milliseconds from <TT>System.currentTimeMillis()</TT>.
 * 
 * @author <A HREF="mailto:razvan.surdulescu@post.harvard.edu">Razvan
 *         Surdulescu</A> (c) 2003 - 2006 <BR>
...
public class NativeTimer {
	...
	/**
	 * Retrieve the current time, in nanoseconds if possible; if not, return the
	 * time in milliseconds, by calling <TT>System.currentTimeMillis()</TT>.
	 */
