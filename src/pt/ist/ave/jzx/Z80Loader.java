...
public class Z80Loader extends BaseLoader
{
	...
	public void load(String paramString) throws IOException {
		URL localURL = new URL(m_url, paramString);
...
class PageHeader
{
	...
	public void load(InputStream paramInputStream)
			throws IOException
			{
		m_pageLength[0] = ((byte)paramInputStream.read());
		m_pageLength[1] = ((byte)paramInputStream.read());
		m_pageNumber = ((byte)paramInputStream.read());
			}
